...
$GLOBALS['TL_LANG']['tl_content']['teasers_legend'] = 'Page teasers';
$GLOBALS['TL_LANG']['tl_content']['pages'][0] = 'Choose page(s)';
$GLOBALS['TL_LANG']['tl_content']['pages'][1] = 'Please choose one or more pages for which a teaser should be displayed.';
$GLOBALS['TL_LANG']['tl_content']['inheritPageImage'][0] = 'Use parent image';
$GLOBALS['TL_LANG']['tl_content']['inheritPageImage'][1] = 'Use image of the parent page if no image is set for a page.';
$GLOBALS['TL_LANG']['tl_content']['useChildPages'][0] = 'Use subpages';
$GLOBALS['TL_LANG']['tl_content']['useChildPages'][1] = 'Use subpages from the chosen page(s).';
