...
$GLOBALS['TL_LANG']['tl_content']['teasers_legend'] = 'Seitenvorschau';
$GLOBALS['TL_LANG']['tl_content']['pages'][0] = 'Seiten auswählen';
$GLOBALS['TL_LANG']['tl_content']['pages'][1] = 'Bitte wählen Sie eine oder mehrere Seiten aus, für die eine Vorschau angezeigt werden soll.';
$GLOBALS['TL_LANG']['tl_content']['inheritPageImage'][0] = 'Übergeordnete Bilder verwenden';
